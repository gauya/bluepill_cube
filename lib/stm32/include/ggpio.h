...
typedef enum { eGPIO_OUTPP=0, eOUTPP = eGPIO_OUTPP, eGPIO_OUTOD, eOUTOD= eGPIO_OUTOD, eGPIO_INPUT, eINPUT= eGPIO_INPUT, eGPIO_ADC, eADC= eGPIO_ADC, eGPIO_EXTI_RISING, eGPIO_EXTI_FALLING, eGPIO_EXTI_RISING_FALLING } egpio_type;
